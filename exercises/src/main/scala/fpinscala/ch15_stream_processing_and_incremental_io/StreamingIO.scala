package fpinscala.ch15_stream_processing_and_incremental_io

import fpinscala.ch13_external_effects_and_io_monad.{IO,Monad,Free,unsafePerformIO}
...
object SimpleStreamTransducers {
  ...
  object Process {
    ...
    import fpinscala.ch13_external_effects_and_io_monad.Monad
...
object GeneralizedStreamTransducers {
  ...
  object Process {
    ...
    import fpinscala.ch13_external_effects_and_io_monad.IO
    ...
    def runLog[O](src: Process[IO,O]): IO[IndexedSeq[O]] = IO {
      ...
      def go(cur: Process[IO,O], acc: IndexedSeq[O]): IndexedSeq[O] =
        cur match {
          ...
          case Await(req,recv) =>
            val next =
              try recv(Right(fpinscala.ch13_external_effects_and_io_monad.unsafePerformIO(req)(E)))
    ...
    import fpinscala.ch13_external_effects_and_io_monad.IO0.fahrenheitToCelsius
